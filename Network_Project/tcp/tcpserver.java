//Juan Taruc CSCI 156 Project - TCP server
...
class TCP_Server
{
   ...
   private static int received_time = 1000; //the specified time the server will repeatedly
   ...
   {
      ServerSocket serverSocket = new ServerSocket(1234); //create a serverSocket with appropriate
