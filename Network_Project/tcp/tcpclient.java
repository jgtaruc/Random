//Juan Taruc CSCI 156 Project - TCP client
//This program will continually send tcp packets
//to the server for the specified send time.
...
class TCP_Client
{
	...
	private static int sending_period = 1000; //the specified time the client will send
										      //packets to the server in milliseconds.
	private static int sending_interval = 5; //delay for each packet sent in milliseconds.
